...
if __name__ == "__main__":
  ...
  print("Computing super-maximal repeats (word-based)...")
  repeats = get_super_maximal_repeats(documents, min_len=3, min_occ=3)

  # print 2 sample repeats if available
  # if len(repeats) > 1:
  #   print("Sample super-maximal repeats (word-based):")
  #   for r in repeats[:2]:
  #     print(f"- {r}")
